...
export default function ArticleCard({
  ...
  return (
    <Link href={`https://nannuru.com/article/${id}`}>
      ...
      >
        <div
          className="bg-white dark:bg-neutral-950 w-[250px] rounded-xl shadow transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
        ...
        >
          <div className="w-full rounded-xl h-[250px] flex-shrink-0 relative overflow-hidden">
            {imgUrl ? (
              ...
              <div className="flex items-center justify-center w-full h-full bg-gray-200 dark:bg-gray-700 text-center text-sm text-gray-600 dark:text-gray-300">
                {" "}
